...
export function SigninForm({
  ...
  // UI state: whether we're currently submitting, and any error message to show.
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // A plain Error can also happen here — e.g. if signin succeeded but
      // loading the user's profile afterwards failed (see AuthContext.tsx).
